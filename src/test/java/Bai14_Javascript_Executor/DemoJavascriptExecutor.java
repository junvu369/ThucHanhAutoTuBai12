package Bai14_Javascript_Executor;
...
public class DemoJavascriptExecutor extends BaseTest {
    ...
    @Test(description = "Scroll to Element")
...
//        js.executeScript("arguments[0].scrollIntoView(true);", webElement);
    ...
    @Test(description = "Highlight phần tử")
    ...
    @Test(description = "Get và Set data cho Local Storage")
